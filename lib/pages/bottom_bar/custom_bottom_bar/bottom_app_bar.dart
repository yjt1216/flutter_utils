...
import 'package:flutter_utils/pages/bottom_bar/custom_bottom_bar/tab_icons.dart';


class JTCustomBottomAppBar extends StatefulWidget {
  const JTCustomBottomAppBar({
    Key? key,
  ...
  @override
  _JTCustomBottomAppBarState createState() => _JTCustomBottomAppBarState();
}

class _JTCustomBottomAppBarState extends State<JTCustomBottomAppBar>
