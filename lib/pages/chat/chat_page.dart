...
// import 'package:flutter_001/utils/websocket_manager.dart';
...
class _ChatPageState extends State<ChatPage> {
  ...
  var _isSendMessage = true; //发送按钮隐藏和显示
  final bool _isInputText = true; //true文本输入  false语言输入
  ...
  bool addShowing = false; /// 加号按钮 显示功能


  List<String> imageList = [
    'assets/chat/chat_photo_album.png',
    'assets/chat/chat_shoot.png',
    'assets/chat/chat_video_call.png',
    'assets/chat/chat_my_collection.png',
    'assets/chat/chat_document.png',
  ];
              ...
              InkWell(
                ...
                onTap: () {
                  ...
                  Future.delayed(const Duration(milliseconds: 10), (){
                    ...
                    if(emojiShowing){
                      _scrollController.jumpTo(_scrollController.position.maxScrollExtent+250.0);
                    }
                  });
                },
              ),
                ...
                itemBuilder: (context, index) {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      Text(titleList[index],style: const TextStyle(color: Colors.black),),
                    ],
                  );
                },
              ),
