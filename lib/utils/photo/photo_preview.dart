          ...
          children: [
            PhotoViewGallery.builder(
                ...
                builder: (BuildContext context, int index) {
                  var imagePath = widget.galleryItems[index];

                  ImageProvider? _picture = (imagePath.startsWith('http')
            ...
            Positioned(///布局自己换
              right: 20,
              top: 20,
              child: Text('$tempSelect/${widget.galleryItems.length}',style: const TextStyle(color:Colors.black),),
            )
          ],
        ),
      ),
